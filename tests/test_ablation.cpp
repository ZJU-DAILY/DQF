...
int main(int argc, char **argv)
{
  ...
  std::string out_recall_path = "/home/zrj/output/qci_ablation_" + dataset_name + "_recall.csv";
...
#pragma omp parallel for
    ...
    out_recall << qps << ',' << recall << std::endl;
    if (pre_recall > 0.99)
      break;
